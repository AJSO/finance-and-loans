                    ...
                    <div class="tab-content">
                        ...
                        <div id="sectionF" class="tab-pane fade in">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="term" class="form-control" style="display: inline; width: 30%" value="<?= $c_payment_scheds["term"]; ?>" />
                                    <select class="form-control" style="display: inline; width: 40%" name="term_period">
                                        <option value="day" <?= $c_payment_scheds["term_period"] === "day" ? 'selected="selected"' : ''; ?>>Day</option>
                                        <option value="week" <?= $c_payment_scheds["term_period"] === "week" ? 'selected="selected"' : ''; ?>>Week</option>
                                        <option value="month" <?= $c_payment_scheds["term_period"] === "monthly" ? 'selected="selected"' : ''; ?>>Month</option>
                                        <option value="year" <?= $c_payment_scheds["term_period"] === "yearly" ? 'selected="selected"' : ''; ?>>Year</option>
                                    </select>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="payment_sched" style="display: inline; width: 30%">
                                        <option value="daily" <?= $c_payment_scheds["payment_sched"] === "daily" ? 'selected="selected"' : ''; ?>>Daily</option>
                                        <option value="weekly" <?= $c_payment_scheds["payment_sched"] === "weekly" ? 'selected="selected"' : ''; ?>>Weekly</option>
                                        <option value="biweekly" <?= $c_payment_scheds["payment_sched"] === "biweekly" ? 'selected="selected"' : ''; ?>>Bi-weekly</option>
                                        <option value="monthly" <?= $c_payment_scheds["payment_sched"] === "monthly" ? 'selected="selected"' : ''; ?>>Monthly</option>
                                        <option value="bimonthly" <?= $c_payment_scheds["payment_sched"] === "bimonthly" ? 'selected="selected"' : ''; ?>>Bi-Monthly</option>
                                        <option value="yearly" <?= $c_payment_scheds["payment_sched"] === "yearly" ? 'selected="selected"' : ''; ?>>Yearly</option>
                                    </select>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class='col-sm-10'>
                                    <input type="text" class="form-control" name="interest_rate" style="display: inline; width: 30%" value="<?= $c_payment_scheds["interest_rate"] ?>" />%
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="penalty" style="display: inline; width: 30%" value="<?= $c_payment_scheds["penalty"] ?>" />%
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
