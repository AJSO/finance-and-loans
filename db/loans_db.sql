...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 21, 2019 at 07:02 AM
...
--
-- Table structure for table `c19_app_config`
--
...
--
-- Dumping data for table `c19_app_config`
--
...
--
-- Table structure for table `c19_attachments`
--
...
--
-- Dumping data for table `c19_attachments`
--
...
--
-- Table structure for table `c19_customers`
--
...
--
-- Dumping data for table `c19_customers`
--
...
--
-- Table structure for table `c19_emails`
--
...
--
-- Table structure for table `c19_employees`
--
...
--
-- Dumping data for table `c19_employees`
--

INSERT INTO `c19_employees` (`username`, `password`, `person_id`, `added_by`, `deleted`) VALUES
('admin', '21232f297a57a5a743894a0e4a801fc3', 1, 0, 0),
('norman0194', '5f3cd85febeeefd6c03b6042c19c24bf', 12, 1, 0),
('user1', '25d55ad283aa400af464c76d713c07ad', 9, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `c19_financial_status`
--
...
--
-- Dumping data for table `c19_financial_status`
--
...
--
-- Table structure for table `c19_grants`
--
...
--
-- Dumping data for table `c19_grants`
--
...
--
-- Table structure for table `c19_guarantee`
--
...
--
-- Dumping data for table `c19_guarantee`
--
...
--
-- Table structure for table `c19_loans`
--
...
--
-- Dumping data for table `c19_loans`
--
...
--
-- Table structure for table `c19_loan_payments`
--
...
--
-- Dumping data for table `c19_loan_payments`
--
...
--
-- Table structure for table `c19_loan_types`
--
...
--
-- Dumping data for table `c19_loan_types`
--
...
--
-- Table structure for table `c19_messages`
--
...
--
-- Table structure for table `c19_modules`
--
...
--
-- Dumping data for table `c19_modules`
--
...
--
-- Table structure for table `c19_payment_schedules`
--
...
--
-- Dumping data for table `c19_payment_schedules`
--
...
--
-- Table structure for table `c19_people`
--
...
--
-- Dumping data for table `c19_people`
--
...
--
-- Table structure for table `c19_permissions`
--
...
--
-- Dumping data for table `c19_permissions`
--
...
--
-- Table structure for table `c19_plugins`
--
...
--
-- Dumping data for table `c19_plugins`
--
...
--
-- Table structure for table `c19_roles`
--
...
--
-- Dumping data for table `c19_roles`
--
...
--
-- Table structure for table `c19_sessions`
--
...
--
-- Dumping data for table `c19_sessions`
--

INSERT INTO `c19_sessions` (`session_id`, `ip_address`, `user_agent`, `last_activity`, `user_data`) VALUES
('04aab20c16cdcd3c1ffd09445dd1d46c', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', 1538196556, 'a:1:{s:9:\"person_id\";s:1:\"1\";}'),
('322e49ba24f33c8408d7cbde2cca1f03', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', 1539549468, ''),
('384ad5c3f2a42823f83779b52fab6538', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.100 Safari/537.36', 1566360593, 'a:1:{s:9:\"person_id\";s:1:\"1\";}'),
('6d22b86d45805388ce83979c21171206', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', 1537099985, 'a:2:{s:9:\"user_data\";s:0:\"\";s:9:\"person_id\";s:2:\"12\";}'),
('9561fc6a53a5ae75ac2c1146c5a2cf02', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', 1540272743, 'a:2:{s:9:\"user_data\";s:0:\"\";s:9:\"person_id\";s:1:\"1\";}'),
('96b7e621d23050350a1e6e61498dbe35', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', 1537105160, ''),
('e825264701dae851a99ec3674aa24bee', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', 1538197919, '');

-- --------------------------------------------------------

--
-- Table structure for table `c19_smtp`
--
...
--
-- Dumping data for table `c19_smtp`
--
...
--
-- Table structure for table `c19_wallets`
--
...
--
-- Indexes for table `c19_app_config`
--
ALTER TABLE `c19_app_config`
  ADD PRIMARY KEY (`key`);

--
-- Indexes for table `c19_attachments`
--
ALTER TABLE `c19_attachments`
  ADD PRIMARY KEY (`attachment_id`);

--
-- Indexes for table `c19_customers`
--
...
--
-- Indexes for table `c19_emails`
--
ALTER TABLE `c19_emails`
  ADD PRIMARY KEY (`email_id`);

--
-- Indexes for table `c19_employees`
--
...
--
-- Indexes for table `c19_payment_schedules`
--
ALTER TABLE `c19_payment_schedules`
  ADD PRIMARY KEY (`payment_schedule_id`);

--
-- Indexes for table `c19_people`
--
ALTER TABLE `c19_people`
  ADD PRIMARY KEY (`person_id`);

--
-- Indexes for table `c19_permissions`
--
...
--
-- Indexes for table `c19_plugins`
--
ALTER TABLE `c19_plugins`
  ADD PRIMARY KEY (`plugin_id`);

--
-- Indexes for table `c19_roles`
--
ALTER TABLE `c19_roles`
  ADD PRIMARY KEY (`role_id`);

--
-- Indexes for table `c19_sessions`
--
ALTER TABLE `c19_sessions`
  ADD PRIMARY KEY (`session_id`);

--
-- Indexes for table `c19_smtp`
--
ALTER TABLE `c19_smtp`
  ADD PRIMARY KEY (`smtp_id`);

--
-- Indexes for table `c19_wallets`
--
...
--
-- AUTO_INCREMENT for table `c19_attachments`
--
ALTER TABLE `c19_attachments`
  MODIFY `attachment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `c19_emails`
--
ALTER TABLE `c19_emails`
  MODIFY `email_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `c19_financial_status`
--
ALTER TABLE `c19_financial_status`
  MODIFY `financial_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `c19_guarantee`
--
ALTER TABLE `c19_guarantee`
  MODIFY `guarantee_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `c19_loans`
--
ALTER TABLE `c19_loans`
  MODIFY `loan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `c19_loan_payments`
--
ALTER TABLE `c19_loan_payments`
  MODIFY `loan_payment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `c19_loan_types`
--
ALTER TABLE `c19_loan_types`
  MODIFY `loan_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `c19_messages`
--
ALTER TABLE `c19_messages`
  MODIFY `message_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `c19_payment_schedules`
--
ALTER TABLE `c19_payment_schedules`
  MODIFY `payment_schedule_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `c19_people`
--
ALTER TABLE `c19_people`
  MODIFY `person_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `c19_plugins`
--
ALTER TABLE `c19_plugins`
  MODIFY `plugin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `c19_roles`
--
ALTER TABLE `c19_roles`
  MODIFY `role_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `c19_smtp`
--
ALTER TABLE `c19_smtp`
  MODIFY `smtp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `c19_wallets`
--
ALTER TABLE `c19_wallets`
...
--
-- Constraints for table `c19_permissions`
--
ALTER TABLE `c19_permissions`
